package com.cybertek.tests.com.cybertek.tests.day15_pom_tests;

import com.cybertek.tests.com.cybertek.pages.CalendarEventsPage;
import com.cybertek.tests.com.cybertek.pages.CreateCalendarEventsPage;
...
public class RepeatOptionsTests extends TestBase {
    ...
    public void RepeatRadioButtonTest(){
        ...
        //verify that repeat weekday is not checked
        Assert.assertFalse(createCalendarEventsPage.weekday.isSelected(),"verify weekday rb not selected");
